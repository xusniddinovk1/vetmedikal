...
class Product1(models.Model):
    category = models.ForeignKey(ProductCategory1, on_delete=models.CASCADE, related_name="products")
...
class ProductFeature1(models.Model):
...
class ProductImage1(models.Model):
    product = models.ForeignKey(Product1, on_delete=models.CASCADE, related_name="images")
