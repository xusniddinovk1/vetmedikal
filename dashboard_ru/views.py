...
def login_page(request):
    if request.method == "POST":
        ...
        if user:
            login(request, user)
            return redirect('ru-admin:home_page')
        else:
...
def profile_edit(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('ru-admin:my_profile')
    else:
...
def service_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:service_list")
...
def feature_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:feature_list")
...
def contact_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:contact_list")
...
def internet_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:internet_list")
...
def mission_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:mission_list")
...
def mission_point_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:mission_point_list")
...
def statistic_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:statistic_list")
...
def value_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:value_list")
...
def achievement_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:achievement_list")
...
def member_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:member_list")
...
def history_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:history_list")
...
def manufacturing_overview_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect('ru-admin:overview_list')
...
def manufacturing_stat_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect('ru-admin:stat_list')
...
def production_line_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect('ru-admin:line_list')
...
def partner_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect('ru-admin:partner_list')
...
def partnership_benefit_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect('ru-admin:benefit_list')
...
def gallery_category_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect('ru-admin:gallery_category_list')
...
def gallery_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect('ru-admin:gallery_list')
...
def category_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect('ru-admin:category_list')
...
def product_category_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:product_category_list")
    return render(request, "dashboard/category/form.html", {"form": form})
...
def product_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:product_list")
...
def product_feature_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:product_feature_list")
...
def image_create(request):
    ...
    if request.method == "POST" and form.is_valid():
        form.save()
        return redirect("ru-admin:image_list")
